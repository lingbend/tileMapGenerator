...
public class BinaryGridTests
{
    ...
    public void BinaryGridChangeBorders_1SameFullGraph_Valid()
    {
        ...
        testGrid._grid = ToBinaryNumber(0b1_111_111_111_111_111_111_111_111_111_111_111_111_111_111_111_111);
        Assert.AreEqual(testGrid, grid, $"test grid: {BinaryNumberToLong(testGrid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");;
    }
    ...
    public void BinaryGridChangeBorders_0FullGraph_Valid()
    {
        ...
        grid.ChangeBorders(0);
        BinaryGrid testGrid = new BinaryGrid(5, 5);
        testGrid._grid = ToBinaryNumber(0b0_000_000_011_111_001_111_100_111_110_011_111_001_111_100_000_000);
        Assert.AreEqual(testGrid, grid, $"test grid: {BinaryNumberToLong(testGrid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");;
    }
    ...
    {
        BinaryGrid grid = new BinaryGrid(5, 5);
        grid._grid = ToBinaryNumber(0b1111111_1000001_1000001_1000001_1000101_1000001_1111111);
        grid.SetCell(2, 2, 0);
    ...
    {
        BinaryGrid grid = new BinaryGrid(5, 5);
        grid._grid = ToBinaryNumber(0b1111111_1000001_1000001_1000001_1000001_1000101_1111111);
    ...
    {
        BinaryGrid grid = new BinaryGrid(5, 5);
        grid._grid = ToBinaryNumber(0b1111111_1000001_1000001_1000001_1000001_1000011_1111111);
        grid.SetCell(1, 1, 0);
    ...
    public void BinaryGridGetCellNeighbors_EachDirectionAs1Middle_All0sExcept1Binary()
    {
        ...
        grid._grid = ToBinaryNumber(0b1111111_1000001_1000001_1000001_1001001_1000001_1111111);
        Assert.AreEqual<uint>(0b010_000_000, grid.GetCellNeighbors(2, 2), "right");

        grid._grid = ToBinaryNumber(0b1111111_1000001_1000001_1000001_1000001_1001001_1111111);
        ...
        grid._grid = ToBinaryNumber(0b1111111_1000001_1000001_1000001_1000011_1000001_1111111);
        Assert.AreEqual<uint>(0b000_001_000, grid.GetCellNeighbors(2, 2), "left");

        grid._grid = ToBinaryNumber(0b1111111_1000001_1000001_1000011_1000001_1000001_1111111);
        Assert.AreEqual<uint>(0b000_000_100, grid.GetCellNeighbors(2, 2), "lower left");

        grid._grid = ToBinaryNumber(0b1111111_1000001_1000001_1000101_1000001_1000000_1111111);
        Assert.AreEqual<uint>(0b000_000_010, grid.GetCellNeighbors(2, 2), "down");

        grid._grid = ToBinaryNumber(0b1111111_1000001_1000001_1001001_1000001_1000001_1111111);
    ...
    public void BinaryGridInsertRow_NormalSizeEmptyGraph_Valid()
    {
        ...
        test_grid._grid = ToBinaryNumber(0b1111111_1000001_1000001_1000001_1000001_1000001_1000001_1111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
    }
    ...
    {
        BinaryGrid grid = new BinaryGrid(5, 5);
        grid._grid = ToBinaryNumber(0b1111111_1010101_1010101_1010101_1010101_1010101_1111111);
        grid.InsertRow(2);
        BinaryGrid test_grid = new BinaryGrid(6, 5);
        test_grid._grid = ToBinaryNumber(0b1111111_1010101_1010101_1010101_1010101_1000001_1010101_1111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
    }
    ...
    public void BinaryGridInsertRow_NormalSizeFullGraph_Valid()
    {
        ...
        grid.InsertRow(2);
        BinaryGrid test_grid = new BinaryGrid(6, 5);
        test_grid._grid = ToBinaryNumber(0b1111111_1111111_1111111_1111111_1111111_1000001_1111111_1111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
    }
    ...
    public void BinaryGridInsertRow_NormalSizeFullGraphSides_Valid()
    {
        ...
        grid.InsertRow(1);
        BinaryGrid test_grid = new BinaryGrid(6, 5);
        test_grid._grid = ToBinaryNumber(0b1111111_1111111_1111111_1111111_1111111_1111111_1000001_1111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
    }
    ...
    public void BinaryGridInsertRow_1WideGrid_Valid()
    {
        ...
        test_grid._grid = ToBinaryNumber(0b111_101_101_101_101_101_101_111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
    } 
    ...
    public void BinaryGridInsertRow_1HighGrid_Valid()
    {
        ...
        test_grid._grid = ToBinaryNumber(0b1111111_1000001_1000001_1111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
    } 
    ...
    public void BinaryGridInsertCol_NormalSizeEmptyGraph_Valid()
    {
        ...
        test_grid._grid = ToBinaryNumber(0b11111111_10000001_10000001_10000001_10000001_10000001_11111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
    }
    ...
    public void BinaryGridInsertCol_NormalSizeAlternatingGraph_Valid()
    {
        ...
        grid.InsertCol(2);
        BinaryGrid test_grid = new BinaryGrid(5, 6);
        test_grid._grid = ToBinaryNumber(0b11111111_10101001_10101001_10101001_10101001_10101001_11111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
    }
    ...
    public void BinaryGridInsertCol_NormalSizeFullGraph_Valid()
    {
        ...
        grid.InsertCol(2);
        BinaryGrid test_grid = new BinaryGrid(5, 6);
        test_grid._grid = ToBinaryNumber(0b11111111_11111011_11111011_11111011_11111011_11111011_11111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
    }
    ...
    public void BinaryGridInsertCol_NormalSizeFullGraphSides_Valid()
    {
        ...
        grid.InsertCol(1);
        BinaryGrid test_grid = new BinaryGrid(5, 6);
        test_grid._grid = ToBinaryNumber(0b11111111_11111101_11111101_11111101_11111101_11111101_11111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
    }
    ...
    public void BinaryGridInsertCol_1WideGrid_Valid()
    {
        ...
        test_grid._grid = ToBinaryNumber(0b1111_1001_1001_1001_1001_1001_1111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
    } 
    ...
    public void BinaryGridInsertCol_1HighGrid_Valid()
    {
        ...
        test_grid._grid = ToBinaryNumber(0b11111111_10000001_11111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
    } 
    ...
    public void BinaryGridDeleteRow_NormalSizeEmptyGraph_Valid()
    {
        ...
        test_grid._grid = ToBinaryNumber(0b1111111_1000001_1000001_1000001_1000001_1111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
    }
    ...
    public void BinaryGridDeleteRow_NormalSizeAlternatingGraph_Valid()
    {
        ...
        grid._grid = ToBinaryNumber(0b1111111_1000001_1010101__1000001_1010101_1111111);
        grid.DeleteRow(2);
        BinaryGrid test_grid = new BinaryGrid(3, 5);
        test_grid._grid = ToBinaryNumber(0b1111111_1000001_1010101__1010101_1111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
    }
    ...
    public void BinaryGridDeleteRow_NormalSizeFullGraph_Valid()
    {
        ...
        grid.DeleteRow(2);
        BinaryGrid test_grid = new BinaryGrid(4, 5);
        test_grid._grid = ToBinaryNumber(0b1111111_1111111_1111111_1111111_1111111_1111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
    }
    ...
    public void BinaryGridDeleteRow_NormalSizeGraphSides_Valid()
    {
        ...
        grid.DeleteRow(1);
        BinaryGrid test_grid = new BinaryGrid(3, 5);
        test_grid._grid = ToBinaryNumber(0b1111111_1000001_1010101__1000001_1111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
    }
    ...
    public void BinaryGridDeleteRow_1WideGrid_Valid()
    {
        ...
        test_grid._grid = ToBinaryNumber(0b111_101_101_101_101_111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
    } 
    ...
    public void BinaryGridDeleteCol_NormalSizeEmptyGraph_Valid()
    {
        ...
        test_grid._grid = ToBinaryNumber(0b111111_100001_100001_100001_100001_100001_111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
    }
    ...
    {
        BinaryGrid grid = new BinaryGrid(4, 5);
        grid._grid = ToBinaryNumber(0b1111111_1010101_1010101__1010101_1010101_1111111);
        grid.DeleteCol(2);
        BinaryGrid test_grid = new BinaryGrid(4, 4);
        test_grid._grid = ToBinaryNumber(0b111111_101001_101001__101001_101001_111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
    }
    ...
    public void BinaryGridDeleteCol_NormalSizeFullGraph_Valid()
    {
        ...
        grid.DeleteCol(2);
        BinaryGrid test_grid = new BinaryGrid(5, 4);
        test_grid._grid = ToBinaryNumber(0b111111_111111_111111_111111_111111_111111_111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
    }
    ...
    public void BinaryGridDeleteCol_NormalSizeGraphSides_Valid()
    {
        ...
        grid.DeleteCol(1);
        BinaryGrid test_grid = new BinaryGrid(4, 4);
        test_grid._grid = ToBinaryNumber(0b111111_100001_101011__100001_101011_111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
    }
    ...
    public void BinaryGridDeleteCol_1HighGrid_Valid()
    {
        ...
        test_grid._grid = ToBinaryNumber(0b111111_100001_111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
    } 
    ...
    public void BinaryGridSetSlice_0s_Valid()
    {
        ...
        test_grid._grid = ToBinaryNumber(0b1111111_1000011_1000011_1000011_1000011_1000011_1111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");

        grid = new BinaryGrid(5, 5);
        grid.SetSlice(2, 2, 4, 2, 1);
        test_grid = new BinaryGrid(5, 5);
        test_grid._grid = ToBinaryNumber(0b1111111_1000001_1000101_1000101_1000101_1000001_1111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");

        grid = new BinaryGrid(5, 5);
        grid.SetSlice(1, 1, 1, 5, 1);
        test_grid = new BinaryGrid(5, 5);
        test_grid._grid = ToBinaryNumber(0b1111111_1000001_1000001_1000001_1000001_1111111_1111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");

        grid = new BinaryGrid(5, 5);
        grid.SetSlice(2, 2, 2, 4, 1);
        test_grid = new BinaryGrid(5, 5);
        test_grid._grid = ToBinaryNumber(0b1111111_1000001_1000001_1000001_1011101_1000001_1111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
    ...
    public void BinaryGridSetSlice_1s_Valid()
    {
        ...
        BinaryGrid test_grid = new BinaryGrid(5, 5);
        test_grid._grid = ToBinaryNumber(0b1111111_1111101_1111101_1111101_1111101_1111101_1111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
        ...
        test_grid = new BinaryGrid(5, 5);
        test_grid._grid = ToBinaryNumber(0b1111111_1111111_1111011_1111011_1111011_1111111_1111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
        ...
        test_grid = new BinaryGrid(5, 5);
        test_grid._grid = ToBinaryNumber(0b1111111_1111111_1111111_1111111_1111111_1000001_1111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
        ...
        test_grid = new BinaryGrid(5, 5);
        test_grid._grid = ToBinaryNumber(0b1111111_1111111_1111111_1111111_1100011_1111111_1111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
    ...
    public void BinaryGridSetSlice_Mixed_Valid()
    {
        ...
        grid.SetSlice(1, 1, 5, 1, 1);
        BinaryGrid test_grid = new BinaryGrid(5, 5);
        test_grid._grid = ToBinaryNumber(0b1111111_1010111_1010111_1010111_1010111_1010111_1111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
        ...
        grid.SetSlice(2, 2, 4, 2, 0);
        test_grid = new BinaryGrid(5, 5);
        test_grid._grid = ToBinaryNumber(0b1111111_1010101_1010001_1010001_1010001_1010101_1111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
        ...
        grid.SetSlice(1, 1, 1, 5, 0);
        test_grid = new BinaryGrid(5, 5);
        test_grid._grid = ToBinaryNumber(0b1111111_1010101_1010101_1010101_1010101_1000001_1111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
        ...
        grid.SetSlice(2, 2, 2, 4, 0);
        test_grid = new BinaryGrid(5, 5);
        test_grid._grid = ToBinaryNumber(0b1111111_1010101_1010101_1010101_1000001_1010101_1111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
    ...
    public void BinaryGridSetGetSlice_SameStartEnd_Valid()
    {
        ...
        BinaryGrid test_grid = new BinaryGrid(5, 5);
        test_grid._grid = ToBinaryNumber(0b1111111_1000001_1000001_1000001_1000001_1000011_1111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
        ...
        test_grid = new BinaryGrid(5, 5);
        test_grid._grid = ToBinaryNumber(0b1111111_1000001_1000001_1010001_1000001_1000001_1111111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
    ...
    public void BinaryGridSetGetSlice_1by1Grid_Valid()
    {
        ...
        test_grid._grid = ToBinaryNumber(0b111_111_111);
        Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
        Assert.AreEqual(0b1U, grid.GetSlice(1, 1, 1, 1));
    }
    ...
    {
        BinaryGrid grid = new BinaryGrid(5, 5);
        grid._grid = ToBinaryNumber(0b1111111_1010101_1010101_1010101_1010101_1000001_1111111);
    ...
    {
        BinaryGrid grid = new BinaryGrid(5, 5);
        grid._grid = ToBinaryNumber(0b1111111_1010101_1010101_1010101_1010101_1001001_1111111);
